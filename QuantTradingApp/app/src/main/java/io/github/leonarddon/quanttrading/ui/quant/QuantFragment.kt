...
import io.github.leonarddon.quanttrading.databinding.FragmentQuantBinding
import io.github.leonarddon.quanttrading.model.BacktestAnalysisPolicy
import io.github.leonarddon.quanttrading.model.BacktestAnalysisReport
import io.github.leonarddon.quanttrading.model.BacktestMetrics
...
import io.github.leonarddon.quanttrading.viewmodel.QuantViewModel
...
class QuantFragment : Fragment() {
    ...
    private fun updateDiagnosticButton() {
        ...
        binding.btnQuantDiagnostic.text = if (report != null) {
            getString(R.string.quant_diagnostic_button_score, report.score)
        } else {
            getString(R.string.quant_diagnostic_button)
        }
    }
