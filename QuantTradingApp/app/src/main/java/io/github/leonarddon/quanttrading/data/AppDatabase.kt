...
data class UserStateEntity(
    ...
    val accountStatus: String = "本机账号数据仅保存在设备上",
...
private const val CURRENT_DATABASE_VERSION = 15
...
private val CURRENT_TABLES = listOf(
    TableSpec(
        ...
        columnsSql = "`id` TEXT NOT NULL, `displayName` TEXT NOT NULL, `phone` TEXT, " +
            "`passwordHash` TEXT, `isLoggedIn` INTEGER NOT NULL, " +
            "`notificationsEnabled` INTEGER NOT NULL, `accountStatus` TEXT NOT NULL, " +
        ...
        columns = listOf(
            ...
            textColumn("accountStatus", "本机账号数据仅保存在设备上"),
            intColumn("createdAt"),
    ...
    TableSpec(
        ...
        columnsSql = "`id` TEXT NOT NULL, `author` TEXT NOT NULL, `title` TEXT NOT NULL, " +
            ...
            "`comments` INTEGER NOT NULL, `category` TEXT NOT NULL, " +
    ...
    TableSpec(
        ...
        columnsSql = "`id` TEXT NOT NULL, `name` TEXT NOT NULL, `description` TEXT NOT NULL, " +
            ...
            "`profitFactor` REAL NOT NULL, `formula` TEXT NOT NULL, " +
