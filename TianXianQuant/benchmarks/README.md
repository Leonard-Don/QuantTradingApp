...
This module hosts Macrobenchmark/Baseline Profile instrumentation tests for the TianXianQuant Android app. It follows the AndroidX Baseline Profile workflow at a project-specific, minimal scope:
